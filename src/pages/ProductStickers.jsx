...
import {ChartDB3} from '../Chart.DB'

export default function ProductStickers() {
...
// const {id} = useParams() 
  return (
    <div className="my-8">
      <div>
        <h1 className="xl:text-3xl lg:text-3xl md:text-2xl sm:text-xl max-sm:text-xl font-bold text-[#FF8000]">Product stickers regular {"{MOQ 100 Pieces}"}</h1>
        <div className='grid max-sm:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-14'>
          {ChartDB3.map((product) => {
